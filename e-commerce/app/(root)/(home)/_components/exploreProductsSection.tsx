			...
			<div className='w-full max-w-6xl mx-auto px-2 sm:px-4'>
				<div className='flex items-start justify-between gap-2 md:gap-4 w-full'>
					<div className='flex flex-col gap-1'>
						<div className='flex items-center gap-2'>
							...
							<span className='text-red-500 text-[15px] font-semibold'>Our Products</span>
						</div>
						<h2 className='mt-3 text-3xl md:text-4xl font-bold'>Explore Our Products</h2>
					</div>
				</div>
				...
				<div className='flex justify-center mt-10'>
					<Button asChild className='bg-red-500 hover:bg-red-600 text-white px-8 h-12 text-base rounded'>
						<Link href='/explore-products'>View All Products</Link>
					</Button>
				</div>
			</div>
		</section>
